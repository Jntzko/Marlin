...
#define Y_ENABLE_PIN                        PB1  //PB11
#define Y_STEP_PIN                          PB0  //PB10
#define Y_DIR_PIN                           PC5  //PB2

#define Z_ENABLE_PIN                        PD2//PB11 //PB1
#define Z_STEP_PIN                          PB3//PB10 //PB0
#define Z_DIR_PIN                           PB4//PB2 //PC5

#define E0_ENABLE_PIN                       PB11//PD2
#define E0_STEP_PIN                         PB10//PB3
#define E0_DIR_PIN                          PB2//PB4
